...
export declare function clean(inputs: IInputs): Promise<any>;
...
export interface ProxiedInvokeInputsArgs {
    ...
    event: string;
    /**
     *  Event funtion: A file containing event data passed to the function during invoke. Http function: A file containing http request options sent to http trigger. Format refers to [https://github.com/devsapp/fc/blob/main/docs/zh/Usage/invoke.md#invoke-http-parameter]
     *  @alias f
     */
    'event-file': string;
    /**
