...
| [移除 remove](docs/zh/command/remove.md)   |                                              |  | [预留 provision](docs/zh/command/provision.md)   | [查看函数 info](docs/zh/command/info.md)  | 
...
|                                          |                                              |   | [层 layer](docs/zh/command/layer.md) |      [压测 stress](docs/zh/command/stress.md)               | 
